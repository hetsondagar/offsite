...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-glow-sm hover:shadow-glow-md hover:brightness-110",
        ...
        glow: "bg-primary text-primary-foreground shadow-glow-lg animate-pulse-glow hover:brightness-110",
        success: "bg-success text-success-foreground shadow-glow-success hover:brightness-110",
        warning: "bg-warning text-warning-foreground shadow-glow-warning hover:brightness-110",
      },
      size: {
